package com.deepblue.aidevicemanager.common;
...
public class MysqlGenerator {
    ...
    private static final String database = "aidevicemanager";
    private static final String url = "jdbc:mysql://localhost/" + database + "?useUnicode=true&useSSL=false&characterEncoding=utf8";
